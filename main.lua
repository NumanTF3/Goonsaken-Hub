...
if true == true then
	function KillerEmoteGUI()
        game:GetService("CoreGui").KillerEmoteGUI:Destroy()
		local KillerEmoteGUI = Instance.new("ScreenGui", game:GetService("CoreGui"))
		...
		KillerEmoteGUI.Parent = game:GetService("CoreGui")
...
if RayfieldLoaded then
    ...
    MiscTab:CreateKeybind({
        ...
        Callback = function()
            if game:GetService("CoreGui"):FindFirstChild("KillerEmoteGUI") == nil then
                KillerEmoteGUI()
            end
        end
    })
